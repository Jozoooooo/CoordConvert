...
public:
	 ...
	 */
	Vector3d BLH2XYH(Vector3d pPoint, Datum pDatum, bool pIs3Dgree, bool pIsUniCoord = true);
	 ...
	 * \return 大地坐标 (大地纬度B, 大地经度L, 大地高H)
	 */
	Vector3d XYH2BLH(Vector3d pPoint, Datum pDatum, bool pIs3Dgree, bool pIsUniCoord = true);
	 ...
	 */
	MatrixXd BLH2XYH(MatrixXd pPoints, Datum pDatum, bool pIs3Dgree, bool pIsUniCoord = true);
	 ...
	 * \return 大地坐标点集 {(大地纬度B, 大地经度L, 大地高H)}
	 */
	MatrixXd XYH2BLH(MatrixXd pPoints, Datum pDatum, bool pIs3Dgree, bool pIsUniCoord = true);
	 ...
	 * \return 度分秒字符串
	 */
	std::string radAng2DmsDeg(double pAngle);
	 ...
	 * \return 度分秒字符串
	 */
	std::string decDeg2DmsDeg(double pAngle);
};